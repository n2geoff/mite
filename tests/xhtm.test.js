...
import { html } from "./.build/test.build.js";
...
describe("Mite - html parser", () => {
    ...
    test("interpolation: strings and numbers", () => {
        ...
        expect(vnode.children).toEqual(["Mite", " v", 2]);
    });
    ...
    test("attributes: static and dynamic", () => {
        ...
        expect(vnode.props.disabled).toBe(true); // Boolean attribute behavior
    });
    ...
    test("cleansing: handles null/undefined in templates", () => {
        ...
        console.log("CHILDERN", vnode.children[0]);
